  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'shadow-[0_20px_60px_-15px_rgba(15,23,42,0.20),_0_8px_24px_-8px_rgba(15,23,42,0.10)]',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 opacity-60 hover:opacity-100 hover:bg-[var(--muted)] transition-all">
        <X className="h-4 w-4" />
