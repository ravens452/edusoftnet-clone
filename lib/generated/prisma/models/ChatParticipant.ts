...
export type ChatParticipantCreateInput = {
  ...
  user: Prisma.UserCreateNestedOneWithoutReceivedThreadsInput
}
...
export type ChatParticipantUpdateInput = {
  ...
  user?: Prisma.UserUpdateOneRequiredWithoutReceivedThreadsNestedInput
}
...
export type ChatParticipantOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"threadId" | "userId" | "joinedAt", ExtArgs["result"]["chatParticipant"]>
...
export interface ChatParticipantDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const chatParticipantWithThreadIdOnly = await prisma.chatParticipant.findMany({ select: { threadId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ChatParticipants and only return the `threadId`
   * const chatParticipantWithThreadIdOnly = await prisma.chatParticipant.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ChatParticipants and only return the `threadId`
   * const chatParticipantWithThreadIdOnly = await prisma.chatParticipant.updateManyAndReturn({
   *   select: { threadId: true },
   *   where: {
   *     // ... provide filter here
   *   },
