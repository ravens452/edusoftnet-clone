...
export type ChatThreadWhereInput = {
  ...
  isGroup?: Prisma.BoolFilter<"ChatThread"> | boolean
...
export type ChatThreadScalarWhereWithAggregatesInput = {
  ...
  isGroup?: Prisma.BoolWithAggregatesFilter<"ChatThread"> | boolean
...
export type ChatThreadOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "isGroup" | "createdAt", ExtArgs["result"]["chatThread"]>
...
export interface ChatThreadFieldRefs {
  ...
  readonly isGroup: Prisma.FieldRef<"ChatThread", 'Boolean'>
